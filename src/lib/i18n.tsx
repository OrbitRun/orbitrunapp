...
const en: Dict = {
 ...
 "coach.thinking.done": "Thanks! I have analyzed your profile. Let's take it one week at a time.",
 "coach.q.vo2max": "VO2 max & you",
 "coach.q.vo2max.help": "If your watch (Garmin, Apple Watch, etc.) reports a VO2 max, enter it here. Otherwise leave it blank — we'll estimate it from your runs.",
 "coach.q.vo2max.fallback": "If you skip this, Orbit estimates your VO2 max from heart rate and pace as soon as you've logged a run.",
 "coach.q.age": "Age",
 "coach.q.gender": "Gender",
 "coach.q.vo2maxKnown": "VO2 max (optional)",
 "coach.q.bio": "About you",
 "coach.q.bio.help": "Age and gender let us calibrate your max heart rate, training zones and VO2-max estimates more precisely.",
 "coach.q.preferKnown": "Use my known VO2 max as truth",
 "coach.q.preferKnown.help": "We'll show your entered value instead of our estimates.",
  "coach.opt.gender.male": "Male",
  "coach.opt.gender.female": "Female",
  "coach.opt.gender.other": "Other",
  "vo2max.label": "VO2 max",
  "vo2max.unit": "ml/kg/min",
  "vo2max.source.user": "From your watch",
  "vo2max.band.poor": "Below average",
  "vo2max.band.fair": "Average",
...
const da: Dict = {
  ...
  "coach.thinking.done": "Tak! Jeg har analyseret din profil. Lad os tage en uge ad gangen.",
  ...
  "coach.q.vo2max": "VO2-max og dig",
  "coach.q.vo2max.help": "Hvis dit ur (Garmin, Apple Watch m.fl.) viser en VO2-max, så indtast den her. Ellers lad feltet stå tomt — vi estimerer den ud fra dine løb.",
  "coach.q.vo2max.fallback": "Springer du over, beregner Orbit din VO2-max ud fra puls og tempo, så snart du har gemt et løb.",
  "coach.q.age": "Alder",
  "coach.q.gender": "Køn",
  "coach.q.vo2maxKnown": "VO2-max (valgfri)",
  "coach.q.bio": "Lidt om dig",
  "coach.q.bio.help": "Alder og køn lader os kalibrere din maksimale puls, dine pulszoner og VO2-max-estimater mere præcist.",
  "coach.q.preferKnown": "Brug min kendte VO2-max som sand værdi",
  "coach.q.preferKnown.help": "Vi viser din indtastede værdi i stedet for vores estimater.",
  "coach.opt.gender.male": "Mand",
  "coach.opt.gender.female": "Kvinde",
  "coach.opt.gender.other": "Andet",
  "vo2max.label": "VO2-max",
  "vo2max.unit": "ml/kg/min",
  "vo2max.source.user": "Fra dit ur",
  "vo2max.band.poor": "Under gennemsnit",
  "vo2max.band.fair": "Gennemsnitligt",
