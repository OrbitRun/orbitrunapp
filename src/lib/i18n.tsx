...
const en: Dict = {
  ...
  "coach.q.vo2max.help": "If your watch (Garmin, Apple Watch, etc.) reports a VO2 max, enter it here. Otherwise leave it blank — we'll estimate it from your runs and your age.",
