...
const en: Dict = {
  ...
  "music.openSpotifyHint": "Open Spotify once to wake the device, then tap Play again.",
  "music.defaultPlaylist": "Default for Orbit Run",
  "music.willAutoPlay": "Plays automatically when you start a run.",
  "music.connectSpotifyInProfile": "Connect Spotify under Profile → Music",
  "profile.musicIntegration": "Music integration",
  "profile.musicIntegrationHint": "Connect Spotify and choose your default workout playlist.",
  "integrations.title": "Integrations",
  "integrations.comingSoon": "Coming soon",
  "integrations.connected": "Connected",
  "integrations.tapToAllow": "Tap to allow",
  "integrations.appleHealth": "Apple Health",
  "integrations.garmin": "Garmin Connect",
  "integrations.strava": "Strava",
  ...
  "history.yearFilter": "Filter by year",
  "records.carousel.eyebrow.year": "{year} records",
  ...
  "profile.environment.title": "Activity environment",
  "profile.environment.outdoor": "Outdoor",
  "profile.environment.indoor": "Indoor",
  "profile.environment.hint": "Indoor turns GPS off and uses watch, phone motion or camera to track your run.",
  "source.gps": "GPS",
  "source.watch": "Watch",
  "source.phone": "Phone",
  ...
  "coach.opt.experience.elite": "Elite",
 ...
 "coach.thinking.done": "I have analyzed your profile.\nLet's take it one week at a time.",
 "coach.welcome.personal": "Welcome {name}! I have calibrated your profile with your weight of {weight} kg and height of {height} cm.",
 "coach.welcome.personalNoBody": "Welcome {name}! Your profile is calibrated and ready to go.",
 "coach.welcome.highFive": "High five! You're all set.",
 ...
 "coach.q.weight": "Weight",
 "coach.q.height": "Height",
 "coach.q.maxHr": "Known max HR (bpm)",
 "coach.q.maxHr.hint": "Leave blank and we'll use 220 − age.",
 "coach.q.vo2maxKnown": "VO2 max (optional)",
 "coach.q.bio": "About you",
 "coach.q.bio.help": "Age, gender, weight and height let us calibrate your max heart rate, training zones, calories and VO2-max estimates more precisely.",
...
"profile.section.myProfile": "My profile",
 ...
 "profile.maxHr": "Max heart rate (bpm)",
 "profile.maxHr.derived": "Using {value} bpm",
 "profile.maxHr.placeholder": "Auto",
  ...
  "sensors.row.title": "Heart rate strap",
  "sensors.row.openInApp": "Open in Orbit app to pair",
  "sensors.row.connected": "Connected: {name}",
  "sensors.row.searching": "Searching…",
  "sensors.row.disconnected": "Disconnected",
  "sensors.row.useHealth": "Tap to use Apple Health",
  "sensors.row.tapToPair": "Tap to pair",
  "sensors.row.poorContact": "Poor contact — moisten the sensor",
  "sensors.row.manage": "Manage",
  "sensors.row.health": "Health",
  "sensors.row.search": "Search",
  "sensors.reconnect": "Reconnect to {name}",
  "sensors.forget": "Forget",
  "sensors.forget.aria": "Forget device",
  "sensors.modal.eyebrow": "Pair sensor",
  "sensors.modal.title": "Heart rate strap",
  "sensors.modal.close": "Close",
  "sensors.step1.eyebrow": "Step 1 · Strap on",
  "sensors.step1.title": "Put on your strap",
  "sensors.step1.body": "Put on your heart rate strap. Moisten the sensors with a little water for better skin contact.",
  "sensors.step1.next": "Next",
  "sensors.step2.eyebrow": "Step 2 · Bluetooth",
  "sensors.step2.title": "Turn on Bluetooth",
  "sensors.step2.body": "Make sure Bluetooth is on, and that your strap isn't connected to another app.",
  "sensors.step2.back": "Back",
  "sensors.step2.search": "Search",
  "sensors.step3.searching.eyebrow": "Step 3 · Searching",
  "sensors.step3.choose.eyebrow": "Step 3 · Choose device",
  "sensors.step3.searching.title": "Searching for sensors…",
  "sensors.step3.choose.title": "Choose your device",
  "sensors.step3.searching.body": "Confirm the device in the browser dialog when it appears.",
  "sensors.step3.choose.body": "Tap Search to open the device picker again.",
  "sensors.trouble.title": "No devices found?",
  "sensors.trouble.body": "Try removing and putting the strap back on, or check whether it's connected to another app (e.g. Strava or Garmin) — Bluetooth can usually only connect to one app at a time.",
  "sensors.health.title": "Can't find your strap?",
  "sensors.health.body": "Use Apple Health instead (requires the strap paired with iPhone)",
  "sensors.action.disconnect": "Disconnect",
  "sensors.action.done": "Done",
  "sensors.action.close": "Close",
  "sensors.action.searching": "Searching…",
  "sensors.action.searchAgain": "Search again",
  "sensors.connected.label": "Connected",
  "sensors.connected.poorTitle": "Poor contact.",
...
const da: Dict = {
  ...
  "music.live": "live",
  "music.choosePlaylist": "Vælg træningsplayliste",
  "music.changePlaylist": "Skift playliste",
  "music.noPlaylistSelected": "Ingen playliste valgt",
  "music.loadingPlaylists": "Henter playlister…",
  "music.noPlaylists": "Ingen playlister fundet",
  "music.playlistLoadError": "Kunne ikke hente playlister. Genforbind Spotify for at give adgang.",
  ...
  "music.openSpotifyHint": "Åbn Spotify én gang for at vække enheden, og tryk Play igen.",
  "music.defaultPlaylist": "Standard for Orbit Run",
  "music.willAutoPlay": "Afspilles automatisk når du starter en løbetur.",
  "music.connectSpotifyInProfile": "Forbind Spotify under Profil → Musik",
  "profile.musicIntegration": "Musik-integration",
  "profile.musicIntegrationHint": "Forbind Spotify og vælg din standard-løbeplayliste.",
  "integrations.title": "Integrationer",
  "integrations.comingSoon": "Kommer snart",
  "integrations.connected": "Tilsluttet",
  "integrations.tapToAllow": "Tryk for at give adgang",
  "integrations.appleHealth": "Apple Health",
  "integrations.garmin": "Garmin Connect",
  "integrations.strava": "Strava",
  "integrations.fitbit": "Fitbit",
  ...
  "history.km": "km",
  "history.allTime": "Hele tiden",
  "history.yearFilter": "Filtrér efter år",
  "records.carousel.eyebrow.year": "{year} rekorder",
  ...
  "profile.environment.title": "Aktivitetstype",
  "profile.environment.outdoor": "Udendørs",
  "profile.environment.indoor": "Indendørs",
  "profile.environment.hint": "Indendørs slår GPS fra og bruger ur, telefonbevægelse eller kamera til at registrere dit løb.",
  "source.gps": "GPS",
  "source.watch": "Ur",
  ...
  "profile.level.novice": "Begynder",
  "profile.level.beginner": "Motionist",
  "profile.level.expert": "Erfaren",
  "profile.level.elite": "Elite",
  "profile.level.noviceHint": "Grundlæggende stats · stemmesignal hver 500 m",
  "profile.level.beginnerHint": "Grundlæggende stats · stemmesignal hver 1 km",
  "profile.level.expertHint": "Avancerede mål · minimale stemmesignaler",
  "profile.level.eliteHint": "Avancerede mål · ambitiøs træningsplan",
 ...
 "coach.thinking.done": "Jeg har analyseret din profil.\nLad os tage en uge ad gangen.",
 "coach.welcome.personal": "Velkommen {name}! Jeg har kalibreret din profil med din vægt på {weight} kg og højde på {height} cm.",
 "coach.welcome.personalNoBody": "Velkommen {name}! Din profil er kalibreret og klar.",
 "coach.welcome.highFive": "High five! Du er klar.",
 "coach.thinking.goalPreview": "Jeg er nu klar til at hjælpe dig mod dit mål: {goal}.",
 "coach.thinking.cta": "GÅ TIL ORBIT COACH",
  "coach.adjust.note.injuryCurrent": "SKÅNSOM GENOPTRÆNING — PASSER PÅ DIN SKADE",
  "coach.adjust.note.injuryPast": "GENOPBYGNING EFTER TIDLIGERE SKADE",
  "coach.adjust.note.lowVolume": "GRADVIS OPBYGNING — IKKE FOR HÅRDT FRA START",
  "coach.adjust.note.lifestyle": "LAVERE BELASTNING — SØVN & STRESS-RESTITUTION",
  ...
  "coach.q.gender": "Køn",
  "coach.q.weight": "Vægt",
  "coach.q.height": "Højde",
  "coach.q.maxHr": "Kendt max-puls (bpm)",
  "coach.q.maxHr.hint": "Lad feltet stå tomt — så bruger vi 220 − alder.",
  "coach.q.vo2maxKnown": "VO2-max (valgfri)",
  "coach.q.bio": "Lidt om dig",
  "coach.q.bio.help": "Alder, køn, vægt og højde lader os kalibrere din maksimale puls, dine pulszoner, kalorier og VO2-max-estimater mere præcist.",
...
"profile.section.myProfile": "Min profil",
  "profile.section.general": "Generelt",
  "profile.weight": "Vægt (kg)",
  "profile.height": "Højde (cm)",
  "profile.maxHr": "Maksimal puls (bpm)",
  "profile.maxHr.derived": "Bruger {value} bpm",
  "profile.maxHr.placeholder": "Auto",
  ...
  "sensors.row.title": "Pulsbælte",
  "sensors.row.openInApp": "Åbn Orbit-appen for at parre",
  "sensors.row.connected": "Forbundet: {name}",
  "sensors.row.searching": "Søger…",
  "sensors.row.disconnected": "Afbrudt",
  "sensors.row.useHealth": "Tryk for at bruge Apple Health",
  "sensors.row.tapToPair": "Tryk for at parre",
  "sensors.row.poorContact": "Dårlig kontakt — fugt sensoren",
  "sensors.row.manage": "Administrer",
  "sensors.row.health": "Health",
  "sensors.row.search": "Søg",
  "sensors.reconnect": "Genforbind til {name}",
  "sensors.forget": "Glem",
  "sensors.forget.aria": "Glem enhed",
  "sensors.modal.eyebrow": "Par sensor",
  "sensors.modal.title": "Pulsbælte",
  "sensors.modal.close": "Luk",
  "sensors.step1.eyebrow": "Trin 1 · Tag bæltet på",
  "sensors.step1.title": "Tag dit pulsbælte på",
  "sensors.step1.body": "Tag dit pulsbælte på. Fugt gerne sensorerne med lidt vand for bedre kontakt med huden.",
  "sensors.step1.next": "Næste",
  "sensors.step2.eyebrow": "Trin 2 · Bluetooth",
  "sensors.step2.title": "Slå Bluetooth til",
  "sensors.step2.body": "Sørg for, at Bluetooth er slået til på din telefon, og at bæltet ikke er forbundet til en anden app.",
  "sensors.step2.back": "Tilbage",
  "sensors.step2.search": "Søg",
  "sensors.step3.searching.eyebrow": "Trin 3 · Søger",
  "sensors.step3.choose.eyebrow": "Trin 3 · Vælg enhed",
  "sensors.step3.searching.title": "Søger efter sensorer…",
  "sensors.step3.choose.title": "Vælg din enhed",
  "sensors.step3.searching.body": "Bekræft enheden i browserens dialog, når den dukker op.",
  "sensors.step3.choose.body": "Tryk Søg for at åbne enhedsvælgeren igen.",
  "sensors.trouble.title": "Ingen enheder fundet?",
  "sensors.trouble.body": "Prøv at tage bæltet af og på igen, eller tjek om det er forbundet til en anden app (f.eks. Strava eller Garmin) — Bluetooth kan ofte kun forbinde til én app ad gangen.",
  "sensors.health.title": "Kan ikke finde dit bælte?",
  "sensors.health.body": "Brug Apple Health i stedet (kræver at bæltet er parret med iPhone)",
  "sensors.action.disconnect": "Afbryd",
  "sensors.action.done": "Færdig",
  "sensors.action.close": "Luk",
  "sensors.action.searching": "Søger…",
  "sensors.action.searchAgain": "Søg igen",
  "sensors.connected.label": "Forbundet",
  "sensors.connected.poorTitle": "Dårlig kontakt.",
