...
const en: Dict = {
  ...
  "plan.session.easy.desc": "Conversational pace where you can hold a full sentence. Builds aerobic base without taxing recovery.",
  "plan.session.long.desc": "Steady, slow-to-moderate effort. Focus on time on feet — slow it down if breathing gets heavy.",
  "plan.session.tempo.desc": "Comfortably hard, just below threshold. After a 10–15 min warm-up, hold the tempo block, then cool down easy.",
  "plan.session.intervals.desc": "Short, fast reps with equal or longer recovery. Warm up well, hit the work intervals at 5K effort, jog the rest.",
  "plan.session.walkRun.desc": "Alternate easy running with brisk walk breaks (e.g. 2 min run / 1 min walk) to build the engine without overload.",
  "plan.session.rest.desc": "Full recovery day. Sleep, hydrate, light mobility. Recovery is when adaptation actually happens.",
  "plan.session.pace": "Pace & effort",
  "plan.session.duration": "Duration",
  "plan.session.startCta": "Start session",
  "plan.session.zone.easy": "Zone 2 · conversational",
  "plan.session.zone.long": "Zone 2 · endurance",
  "plan.session.zone.tempo": "Zone 3–4 · comfortably hard",
  "plan.session.zone.intervals": "Zone 4–5 · 5K effort",
  "plan.session.zone.walkRun": "Zone 1–2 · build the habit",
  "plan.session.zone.rest": "Recovery",
...
const da: Dict = {
  ...
  "plan.session.easy.desc": "Snak-tempo hvor du kan holde en hel sætning. Bygger aerob base uden at belaste din restitution.",
  "plan.session.long.desc": "Roligt og stabilt. Fokus er tid på benene — sæt tempoet ned hvis vejrtrækningen bliver tung.",
  "plan.session.tempo.desc": "Behageligt hårdt, lige under tærskel. Varm op 10–15 min, hold tempoblokken, og jog ud i ro.",
  "plan.session.intervals.desc": "Korte, hurtige intervaller med lige så lang eller længere pause. Varm grundigt op, kør intervallerne i 5 km-tempo, jog i pauserne.",
  "plan.session.walkRun.desc": "Skift mellem roligt løb og rask gang (fx 2 min løb / 1 min gang). Bygger motoren uden at overbelaste.",
  "plan.session.rest.desc": "Fuld restitutionsdag. Sov, drik vand, lidt let mobilitet. Det er her tilpasningen sker.",
  "plan.session.pace": "Tempo & belastning",
  "plan.session.duration": "Varighed",
  "plan.session.startCta": "Start træning",
  "plan.session.zone.easy": "Zone 2 · snak-tempo",
  "plan.session.zone.long": "Zone 2 · udholdenhed",
  "plan.session.zone.tempo": "Zone 3–4 · behageligt hårdt",
  "plan.session.zone.intervals": "Zone 4–5 · 5 km-tempo",
  "plan.session.zone.walkRun": "Zone 1–2 · byg vanen",
  "plan.session.zone.rest": "Restitution",
