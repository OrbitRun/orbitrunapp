...
const en: Dict = {
  ...
  "plan.title": "My training journey",
  "plan.weekOf": "Week {current} of {total}",
  "plan.weekShort": "Wk",
  "plan.sessions": "sessions complete",
  "plan.now": "Now",
  "plan.estimated": "Estimated",
  "plan.editGoal": "Edit goal",
  "plan.session.easy": "Easy run",
  "plan.session.long": "Long run",
  "plan.session.tempo": "Tempo run",
  "plan.session.intervals": "Intervals",
  "plan.session.walkRun": "Walk/run",
  "plan.session.rest": "Rest day",
  "plan.reason.short": "Adjusted by AI · ran shorter than planned",
  "plan.reason.highLoad": "Adjusted by AI · high training load",
  "plan.reason.lowHrv": "Adjusted by AI · low HRV recovery",
  "plan.editor.eyebrow": "Adapt your plan",
  "plan.editor.title": "Edit goal",
  "plan.editor.distance": "Distance",
  "plan.editor.targetDate": "Target date",
  "plan.editor.ambition": "Ambition",
  "plan.editor.save": "Save & regenerate",
  "plan.dist.5k": "5 km",
  "plan.dist.10k": "10 km",
  "plan.dist.half": "Half marathon",
  "plan.dist.marathon": "Marathon",
  "plan.amb.finish": "Finish",
  "plan.amb.pr": "PR",
  "plan.amb.elite": "Elite",
  "plan.reason.injury": "Adjusted by AI · easing in around your injury",
  "plan.reason.lowVolume": "Adjusted by AI · ramping up gently from your current mileage",
  "plan.reason.newbie": "Adjusted by AI · soft start to build the habit",
  "onb.step.weeklyKm": "How much do you currently run per week?",
  "onb.hint.weeklyKm": "Be honest — your plan starts from here.",
  "onb.weeklyKm.0": "0 km",
  "onb.weeklyKm.0-10": "0–10 km",
  "onb.weeklyKm.10-25": "10–25 km",
  "onb.weeklyKm.25+": "25+ km",
  "onb.step.experience": "Your running experience",
  "onb.experience.newbie": "Newbie",
  "onb.experience.casual": "Casual",
  "onb.experience.regular": "Regular",
  "onb.experience.experienced": "Experienced",
  "onb.step.sleep": "How well do you usually sleep?",
  "onb.hint.sleep": "Average over the past few weeks.",
  "onb.scale.sleepLow": "Poor",
  "onb.scale.sleepHigh": "Excellent",
  "onb.step.stress": "How stressed do you feel day-to-day?",
  "onb.hint.stress": "Work, family, life — all of it.",
  "onb.scale.stressLow": "Calm",
  "onb.scale.stressHigh": "Very high",
  "onb.step.injuries": "Any current or recurring injuries?",
  "onb.injuries.no": "None",
  "onb.injuries.yes": "Yes",
  "onb.injuries.placeholder": "E.g. left knee, IT band, plantar fasciitis…",
  "onb.step.preferredDays": "Preferred training days",
  "onb.hint.preferredDays": "We'll place hard sessions on these days.",
  "onb.seePlan": "See my plan",
  "onb.finish.title": "Thanks! I've analyzed your profile, injury history, and current level.",
  "onb.finish.body": "Your data is in good hands.",
  "onb.finish.previewLabel": "Your plan",
  "onb.finish.preview": "Your personal 12-week plan toward {goal} is ready.",
};
...
const da: Dict = {
  ...
  "plan.amb.elite": "Elite",
  "plan.reason.injury": "Justeret af AI · skånsom start omkring din skade",
  "plan.reason.lowVolume": "Justeret af AI · blid optrapning fra dit nuværende niveau",
  "plan.reason.newbie": "Justeret af AI · blød start for at bygge vanen",
  "onb.step.weeklyKm": "Hvor meget løber du om ugen lige nu?",
  "onb.hint.weeklyKm": "Vær ærlig — planen starter herfra.",
  "onb.weeklyKm.0": "0 km",
  "onb.weeklyKm.0-10": "0–10 km",
  "onb.weeklyKm.10-25": "10–25 km",
  "onb.weeklyKm.25+": "25+ km",
  "onb.step.experience": "Din løbeerfaring",
  "onb.experience.newbie": "Nybegynder",
  "onb.experience.casual": "Afslappet",
  "onb.experience.regular": "Fast løber",
  "onb.experience.experienced": "Erfaren",
  "onb.step.sleep": "Hvor godt sover du normalt?",
  "onb.hint.sleep": "Gennemsnit over de seneste uger.",
  "onb.scale.sleepLow": "Dårligt",
  "onb.scale.sleepHigh": "Fantastisk",
  "onb.step.stress": "Hvor stresset er du i hverdagen?",
  "onb.hint.stress": "Arbejde, familie, livet — det hele.",
  "onb.scale.stressLow": "Roligt",
  "onb.scale.stressHigh": "Meget højt",
  "onb.step.injuries": "Har du aktuelle eller tilbagevendende skader?",
  "onb.injuries.no": "Ingen",
  "onb.injuries.yes": "Ja",
  "onb.injuries.placeholder": "F.eks. venstre knæ, IT-bånd, plantar fasciit…",
  "onb.step.preferredDays": "Foretrukne træningsdage",
  "onb.hint.preferredDays": "Vi placerer de hårde pas på disse dage.",
  "onb.seePlan": "Se min plan",
  "onb.finish.title": "Tak! Jeg har nu analyseret din profil, din skadeshistorik og dit nuværende niveau.",
  "onb.finish.body": "Dine data er i gode hænder.",
  "onb.finish.previewLabel": "Din plan",
  "onb.finish.preview": "Din personlige 12-ugers plan mod {goal} er nu genereret og klar.",
};
