...
const da: Dict = {
  ...
  "coach.q.vo2max.help": "Hvis dit ur (Garmin, Apple Watch m.fl.) viser en VO2-max, så indtast den her. Ellers lad feltet stå tomt — vi estimerer den ud fra dine løb og din alder.",
