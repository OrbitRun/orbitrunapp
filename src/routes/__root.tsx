...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "ORBIT RUN tracks your runs with GPS, displaying distance, pace, and elevation on a dynamic speed-heatmap." },
      { name: "twitter:description", content: "ORBIT RUN tracks your runs with GPS, displaying distance, pace, and elevation on a dynamic speed-heatmap." },
